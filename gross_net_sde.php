...
WHERE A.SDE=B.SDE";
		...
		while($data = odbc_fetch_array($odbcexec))
		{
			...
			echo "<td><a href='gross_net_det.php?sde=SSA&fdate=" .$fdate. "&tdate=" .$tdate. "&service=FTTH&order_type=PROV&order_Sub_type=LL&sdca=" .$data['SDE']. "' target='_blank'>" .$data['LLONLYPROV']. "</a></td>";
			...
			echo "<td><a href='gross_net_det.php?sde=SSA&fdate=" .$fdate. "&tdate=" .$tdate. "&service=FTTH&order_type=DIS&order_Sub_type=LL&sdca=" .$data['SDE']. "' target='_blank'>" .$data['LLONLYDIS']. "</a></td>";
